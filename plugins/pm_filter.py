...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if chat_type == "private":
            ...
            return await query.answer('𝐓𝐇𝐀𝐍𝐊𝐒 𝐅𝐎𝐑 𝐔𝐒𝐈𝐍𝐆 𝐎𝐔𝐑 𝐁𝐎𝐓')
    ...
    if query.data.startswith("file"):
        ...
        await query.answer('𝐓𝐇𝐀𝐍𝐊𝐒 𝐅𝐎𝐑 𝐔𝐒𝐈𝐍𝐆 𝐎𝐔𝐑 𝐁𝐎𝐓')
        ...
        buttons = [[
            InlineKeyboardButton('🤖 ᴀʟʟ ᴘʀᴏᴊᴇᴄᴛs', url='https://t.me/NCM_LINKS'),
            InlineKeyboardButton('♥️ sᴜᴘᴘᴏʀᴛ', callback_data='source')
        ], [
            InlineKeyboardButton('🏠 ʜᴏᴍᴇ', callback_data='start'),
        ...
        await query.answer("𝐅𝐞𝐭𝐜𝐡𝐢𝐧𝐠 𝐃𝐚𝐭𝐚 𝐟𝐫𝐨𝐦 𝐌𝐨𝐧𝐠𝐨𝐃𝐛")
        buttons = [[
            InlineKeyboardButton('👩‍🦯 ʙᴀᴄᴋ', callback_data='help'),
            InlineKeyboardButton('♻️ ʀᴇғʀᴇsʜ', callback_data='rfrsh')
        ]]
...
async def advantage_spell_chok(msg):
    ...
    await msg.reply("ʜᴇʏ ʙʀᴏ ɪ ᴄᴏᴜʟᴅ ɴᴏᴛ ғɪɴᴅ ᴀɴʏᴛʜɪɴɢ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ ᴛʜᴀᴛ\nʏᴏᴜʀ sᴘᴇʟʟɪɴɢs ᴀʀᴇ ᴠᴇʀʏ ʙᴀᴅ\nᴅɪᴅ ʏᴏᴜ ᴍᴇᴀɴ ᴀɴʏ ᴏғ ᴛʜᴇ ʙᴇʟᴏᴡ?",
                    reply_markup=InlineKeyboardMarkup(btn))
